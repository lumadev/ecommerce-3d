...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "group peer sticky top-0 z-10 flex h-screen flex-none flex-col overflow-hidden",
    ...
    >
      <div
        data-sidebar="sidebar"
        className={cn(
          "flex h-full w-[--sidebar-width] min-w-[--sidebar-width] flex-col bg-sidebar overflow-y-auto",
